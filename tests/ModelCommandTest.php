...
class ModelCommandTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        try {
            ...
            $this->db->query("SELECT 1 FROM ktvs_models LIMIT 1");
            $this->db->query("SELECT 1 FROM ktvs_models_albums LIMIT 1");
    ...
    {
        // Get a model ID
        $stmt = $this->db->query("SELECT model_id FROM ktvs_models LIMIT 1");
